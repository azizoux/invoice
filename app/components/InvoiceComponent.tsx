...
const InvoiceComponent: React.FC<InvoiceComponentProps> = ({
  ...
  const getStatusBadge = (status: number) => {
    switch (status) {
      case 1:
        return (
          <div className="badge badge-lg items-center gap-2">
      ...
      case 2:
        return (
          <div className="badge badge-lg badge-warning items-center gap-2">
            <Clock className="w-4" />
            En attente
          </div>
        );
      case 3:
        return (
          <div className="badge badge-lg badge-success items-center gap-2">
      ...
      case 4:
        return (
          <div className="badge badge-lg badge-info items-center gap-2">
      ...
      case 5:
        return (
          <div className="badge badge-lg badge-error items-center gap-2">
            <XCircle className="w-4" />
            Impayée
          </div>
        );
      default:
        return (
          <div className="badge badge-lg badge-secondary items-center gap-2">
            <XCircle className="w-4" />
            Indefinie
          </div>
        );
